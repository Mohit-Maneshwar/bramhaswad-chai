  ...
  return (
    <footer className="bg-green-950 text-gray-300 pt-12 pb-6 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Ek dum kadak taste aur rich aroma ke saath, Bramhaswad Rajvadi 
            Kadak Chai aapki subah ko banaye aur bhi energetic. 
            Pure, strong aur 100% natural.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/order" className="hover:text-yellow-400">Order Now</a></li>
        ...
        <div>
          ...
          <div className="flex gap-4 mt-4">
            <a href="#" className="hover:text-yellow-400"><Facebook size={22} /></a>
            <a href="#" className="hover:text-yellow-400"><Instagram size={22} /></a>
            <a href="#" className="hover:text-yellow-400"><Twitter size={22} /></a>
          </div>
        </div>
      </div>
      ...
      <div className="text-center text-sm text-gray-500 border-t border-gray-700 mt-10 pt-4">
        © {new Date().getFullYear()} Bramhaswad Foods & Spices Pvt. Ltd. | All Rights Reserved
      </div>
    </footer>
  );
}
